# SUSE® Rancher Prime: K3s Product Documentation

This repository is used to publish the documentation on the [SUSE Documentation website](https://documentation.suse.com/cloudnative/k3s/). For inquiries about the K3s software, please refer to [K3s GitHub repository](https://github.com/k3s-io/k3s/).
...
```
git clone https://github.com/rancher/k3s-product-docs.git
```
...
1. [Open an issue](https://github.com/rancher/k3s-product-docs/issues/new/choose).
1. Edit the documentation in the way you see fit and submitting a [pull request](https://github.com/rancher/k3s-product-docs/compare).

### File Organization

#### Content and Asset Files

Most contributions will target these files and can be found under the `docs/latest/modules/<LOCALE>` directory.
