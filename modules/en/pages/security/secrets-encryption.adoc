...
Use `+curl -sfL https://get.k3s.io | sh -s - server --secrets-encryption+` if installing from script, or other methods described in link:../installation/configuration.adoc#configuration-with-install-script[Configuration Options].
====
