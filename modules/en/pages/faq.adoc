...
2) Check that you have resolved any xref:./installation/requirements.adoc#_operating-systems[Additional OS Preparation]. Run `k3s check-config` and ensure that it passes.
