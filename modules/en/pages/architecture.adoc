...
* Both servers and agents run the kubelet, container runtime, and CNI. See the xref:./advanced.adoc#running-agentless-servers-experimental[Advanced Options] documentation for more information on running agentless servers.
