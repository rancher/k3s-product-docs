...
+
--
Older Debian release may suffer from a known iptables bug. See xref:../known-issues.md#iptables[Known Issues].
...
+
--
Raspberry Pi OS is Debian based, and may suffer from a known iptables bug. See xref:../known-issues.md#iptables[Known Issues].
