...
For more details on how these components work together, refer to the xref:../architecture.adoc#high-availability-k3s-server-with-an-external-db[architecture section.]
