...
These options can be passed in with the command line, or in the xref:../installation/configuration.md#configuration-file[configuration file,] which may be easier to use.
