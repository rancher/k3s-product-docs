...
2) 检查你是否已解决xref:./advanced.adoc#_其他操作系统准备[其他操作系统准备]。运行 `k3s check-config` 并确保它通过。
...
5) 在 K3s Github 上提交link:https://github.com/k3s-io/k3s/issues/new/choose[新 issue]，你可以描述你的设置和遇到的问题。
