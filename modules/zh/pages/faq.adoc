...
要获得更多日志选项，请参阅link:./advanced.adoc#其他日志来源[其他日志来源]。

== 可以在 Docker 中运行 K3s 吗？

是的，有几种方法可以让你在 Docker 中运行 K3s。有关详细信息，请参阅link:./advanced.adoc#在-docker-中运行-k3s[高级选项]。
...
2) 检查你是否已解决link:./advanced.adoc#其他操作系统准备[其他操作系统准备]。运行 `k3s check-config` 并确保它通过。
