...
スクリプトからインストールする場合は `+curl -sfL https://get.k3s.io | sh -s - server --secrets-encryption+` を使用するか、link:../installation/configuration.adoc#configuration-with-install-script[設定オプション]に記載されている他の方法を使用してください。
====
