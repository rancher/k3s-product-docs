...
For more details on how these components work together, refer to the xref:architecture.adoc#_high_availability_k3s_server_with_an_external_db[architecture section.]
