...
* *Traefik*：如果没有禁用 Traefik，K3s 1.20 及以前的版本将安装 Traefik v1，而 K3s 1.21 及以后的版本将安装 Traefik v2。要将旧版 Traefik v1 升级到 Traefik v2，请参阅 https://doc.traefik.io/traefik/migrate/v1-to-v2/[Traefik 文档]并使用link:https://github.com/traefik/traefik-migration-tool[迁移工具]。
