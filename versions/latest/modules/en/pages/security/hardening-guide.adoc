...
Refer to xref:security/self-assessment-1.8.adoc#_51_rbac_and_service_accounts[CIS 1.8 Section 5] for more information on how to create and apply these policies.
