...
The datastore endpoint format differs based on the database type. For details, refer to the section on xref:./datastore.adoc#_datastore-endpoint-format-and-functionality[datastore endpoint formats.]

To configure TLS certificates when launching server nodes, refer to the xref:./datastore.adoc#_external-datastore-configuration-parameters[datastore configuration guide.]
