= k3s certificate
:description: Manage k3s client and server certificates by checking expiration dates, rotating them manually when needed, and understanding how automatic renewal extends their validity
