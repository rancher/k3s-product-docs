...
:description: Install a high-availability K3s cluster with an external database by setting up a datastore, launching server nodes, and configuring the cluster
...
[#_4_optional_configure_a_fixed_registration_address]
