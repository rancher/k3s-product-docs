...
:description: Deploy a distributed hybrid or multicloud cluster using K3s with either the embedded multicloud solution or Tailscale integration
...
[#_embedded_k3s_multicloud_solution]
