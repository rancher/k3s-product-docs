= Networking Services
:description: Learn how CoreDNS, Traefik Ingress controller, Network Policy controller, and ServiceLB work in K3s
:revdate: 2026-05-29
...
Traefik is compatible with https://gateway-api.sigs.k8s.io/reference/api-spec/1.4/spec/[Gateway API v1.4].
...
[WARNING]
====
If you need support for experimental Gateway API resources, e.g. TCPRoute, you must install the https://github.com/kubernetes-sigs/gateway-api/releases/download/v1.4.0/experimental-install.yaml[v1.4 experimental-install.yaml] from the official https://github.com/kubernetes-sigs/gateway-api/releases/tag/v1.4.0[gateway-api releases] and use the option `providers.kubernetesGateway.experimentalChannel=true` in the k3s-traefik chart values.
====

[#_network_policy_controller]
...
[#_creating_servicelb_node_pools]
