= Cluster Access
:description: Use the admin kubeconfig file stored at /etc/rancher/k3s/k3s.yaml to access the Kubernetes cluster with kubectl by setting the KUBECONFIG environment variable
