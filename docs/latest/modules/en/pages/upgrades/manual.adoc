= Manual Upgrades
:description: Upgrade K3s manually by replacing the existing binary with a new one, copying it to /usr/local/bin/k3s, and restarting the service
...
[#_upgrade_k3s_using_the_installation_script]
