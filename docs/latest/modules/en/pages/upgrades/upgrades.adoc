= Upgrades
:description: Upgrade your K3s cluster manually using techniques described here or automate upgrades with Rancher's system-upgrade-controller
:page-languages: [en, de, es, fr, ja, pt, zh]
:revdate: 2024-09-11
:page-revdate: {revdate}

[#_upgrading_your_k3s_cluster]
