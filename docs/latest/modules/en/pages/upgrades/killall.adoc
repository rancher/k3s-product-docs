= Stopping K3s
:description: Stop K3s from using the systemd or OpenRC installation scripts, or the killall script, to manage containers, reset containerd's state, and preserve cluster data
