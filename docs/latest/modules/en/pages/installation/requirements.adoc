= Requirements
:description: Learn the minimum system requirements for K3s, including supported architectures, OS-specific configurations, and hostname rules
:revdate: 2026-07-22
...
| TCP
| 2382
| etcd legacy HTTP API

| TCP
| 6444
| kube-apiserver local access

| TCP
| 10010
| containerd and cri-dockerd CRI service exec/logs streaming
