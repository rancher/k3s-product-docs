= Air-Gap Install
:description: Install K3s in an air-gapped environment using a private registry or manually deploying images to nodes
...
[#_download_the_binary_and_script]
