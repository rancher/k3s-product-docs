...
:description: Configure private registry settings by editing the registries.yaml file to define mirrors, redirects, rewrites, and specify authentication or custom TLS
...
| `auth`
| base64 encode of the username:password
|===
...
[#_adding_images_to_the_private_registry]
