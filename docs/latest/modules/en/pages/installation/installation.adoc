= Installation
:description: Install K3s in various environments using instructions for requirements, configuration options, private registry setup, air-gap install, and server roles
