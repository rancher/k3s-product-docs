...
:description: Configure K3s using environment variables, install scripts, binaries, container images, and configuration files
...
[#_configuration_with_container_image]
