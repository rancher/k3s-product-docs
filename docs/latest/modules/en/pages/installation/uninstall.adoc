= Uninstalling K3s
:description: Uninstall K3s from a server or agent node by running the uninstall script to stop the service and delete local cluster data
