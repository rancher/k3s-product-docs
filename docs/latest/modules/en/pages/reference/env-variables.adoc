...
:description: Configure K3s installation with environment variables to set service options, modify the PATH for container runtimes, and edit systemd or OpenRC service files
