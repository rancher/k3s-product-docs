= Metrics
:description: Monitor the health and performance of your K3s cluster using metrics from components and exposed endpoints
...
[#_k3s_cluster_management_metrics]
== K3s Cluster Management Metrics

[#_k3s_certificate_expiration_seconds]
...
[#_k3s_loadbalancer_server_connections]
...
[#_k3s_loadbalancer_server_health]
...
[#_k3s_loadbalancer_dial_duration_seconds]
...
[#_k3s_etcd_snapshot_save_duration_seconds]
...
[#_k3s_etcd_snapshot_save_local_duration_seconds]
...
[#_k3s_etcd_snapshot_save_s3_duration_seconds]
...
[#_k3s_etcd_snapshot_reconcile_duration_seconds]
...
[#_k3s_etcd_snapshot_reconcile_local_duration_seconds]
...
[#_k3s_etcd_snapshot_reconcile_s3_duration_seconds]
