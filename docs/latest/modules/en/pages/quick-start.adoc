= Quick-Start Guide
:description: Launch a Kubernetes cluster using the K3s install script, which automatically configures the service, installs utilities, and creates a kubeconfig file
