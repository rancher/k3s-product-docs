= v1.30.X
:description: View release notes for version v1.30.X to see updates to Kubernetes, bug fixes, and changes like adding usage descriptions, image builds, and Go version
...
| xref:#_release_v1_30_14k3s2[v1.30.14+k3s2]
| Jul 26 2025
...
| xref:#_release_v1_30_14k3s1[v1.30.14+k3s1]
| Jun 30 2025
| https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.30.md#v13014[v1.30.14]
...
== Release https://github.com/k3s-io/k3s/releases/tag/v1.30.14+k3s2[v1.30.14+k3s2]
// v1.30.14+k3s2

This release updates Kubernetes to v1.30.14, and fixes a number of issues.

For more details on what's new, see the https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.30.md#changelog-since-v13014[Kubernetes release notes].

=== Changes since v1.30.14+k3s1:

* Add usage description for etcd-snapshot https://github.com/k3s-io/k3s/pull/12571[(#12571)]
* Build and push k3s image to GHCR https://github.com/k3s-io/k3s/pull/12576[(#12576)]
* GHA + Testing Backports https://github.com/k3s-io/k3s/pull/12611[(#12611)]
...
* Backports for 2025-07 https://github.com/k3s-io/k3s/pull/12643[(#12643)]
* Update to v1.30.14-k3s2 and Go 1.23.10 https://github.com/k3s-io/k3s/pull/12662[(#12662)]

'''

== Release https://github.com/k3s-io/k3s/releases/tag/v1.30.14+k3s1[v1.30.14+k3s1]
// v1.30.14+k3s1

This release updates Kubernetes to v1.30.14, and fixes a number of issues.

For more details on what's new, see the https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.30.md#changelog-since-v13013[Kubernetes release notes].

=== Changes since v1.30.13+k3s1:

* Backports for 2025-06 https://github.com/k3s-io/k3s/pull/12499[(#12499)]
* Bump helm-controller https://github.com/k3s-io/k3s/pull/12521[(#12521)]
* Update network components https://github.com/k3s-io/k3s/pull/12516[(#12516)]
* Update to v1.30.14-k3s1 and Go 1.23.10 https://github.com/k3s-io/k3s/pull/12532[(#12532)]
