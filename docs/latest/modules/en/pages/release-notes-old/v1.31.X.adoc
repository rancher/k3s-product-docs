= v1.31.X
:description: Upgrade to v1.31.X to update Kubernetes to v1.31.14, apply fixes for CLI, network plugins, etcd, and other components, and review the release notes
...
| xref:#_release_v1_31_14k3s1[v1.31.14+k3s1]
| Nov 20 2025
| https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.31.md#v13114[v1.31.14]
| https://github.com/k3s-io/kine/releases/tag/v0.14.6-k3s1.31[v0.14.6-k3s1.31]
...
| xref:#_release_v1_31_13k3s1[v1.31.13+k3s1]
| Sep 22 2025
...
| xref:#_release_v1_31_12k3s1[v1.31.12+k3s1]
| Aug 25 2025
...
== Release https://github.com/k3s-io/k3s/releases/tag/v1.31.14+k3s1[v1.31.14+k3s1]
// v1.31.14+k3s1

This release updates Kubernetes to v1.31.14, and fixes a number of issues.

For more details on what's new, see the https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.31.md#changelog-since-v13113[Kubernetes release notes].

=== Changes since v1.31.13+k3s1:

* Fix garbled CLI https://github.com/k3s-io/k3s/pull/13035[(#13035)]
* Update flannel, kube-router and cni plugins https://github.com/k3s-io/k3s/pull/13043[(#13043)]
* Backports for 2025-10 https://github.com/k3s-io/k3s/pull/13060[(#13060)]
...
* Update dispatch script https://github.com/k3s-io/k3s/pull/13075[(#13075)]
* Bump helm-controller/klipper-helm https://github.com/k3s-io/k3s/pull/13094[(#13094)]
* Backports for 2025-11 https://github.com/k3s-io/k3s/pull/13128[(#13128)]
* Inclusive naming proposal https://github.com/k3s-io/k3s/pull/13135[(#13135)]
* Migrate release pipeline into GitHub Actions https://github.com/k3s-io/k3s/pull/13118[(#13118)]
* Bump runc to v1.2.8 https://github.com/k3s-io/k3s/pull/13146[(#13146)]
* Add Prime assets upload https://github.com/k3s-io/k3s/pull/13156[(#13156)]
* More backports for 2025-11 https://github.com/k3s-io/k3s/pull/13180[(#13180)]
* Bump klipper-helm and helm-controller https://github.com/k3s-io/k3s/pull/13196[(#13196)]
* Update to v1.31.14-k3s1 and Go 1.24.9 https://github.com/k3s-io/k3s/pull/13203[(#13203)]
* Add id-token https://github.com/k3s-io/k3s/pull/13205[(#13205)]

'''

== Release https://github.com/k3s-io/k3s/releases/tag/v1.31.13+k3s1[v1.31.13+k3s1]
// v1.31.13+k3s1

This release updates Kubernetes to v1.31.13, and fixes a number of issues.

For more details on what's new, see the https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.31.md#changelog-since-v13112[Kubernetes release notes].

=== Changes since v1.31.12+k3s1:

* Backports for 2025-09 https://github.com/k3s-io/k3s/pull/12887[(#12887)]
...
* Update to v1.31.13-k3s1 and Go 1.23.12 https://github.com/k3s-io/k3s/pull/12893[(#12893)]

'''

== Release https://github.com/k3s-io/k3s/releases/tag/v1.31.12+k3s1[v1.31.12+k3s1]
// v1.31.12+k3s1

This release updates Kubernetes to v1.31.12, and fixes a number of issues.
For more details on what's new, see the https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.31.md#changelog-since-v13111[Kubernetes release notes].

=== Changes since v1.31.11+k3s1:

* Add retention flag specific for s3 https://github.com/k3s-io/k3s/pull/12696[(#12696)]
* Backport For August https://github.com/k3s-io/k3s/pull/12721[(#12721)]
* Bump coredns to 1.12.3 https://github.com/k3s-io/k3s/pull/12732[(#12732)]
* Bump metrics-server to v0.8.0 https://github.com/k3s-io/k3s/pull/12743[(#12743)]
* Fix cert startup check events https://github.com/k3s-io/k3s/pull/12748[(#12748)]
* Emit certs OK event on startup, if no certs need renewal https://github.com/k3s-io/k3s/pull/12762[(#12762)]
* Update metric help to be more descriptive. https://github.com/k3s-io/k3s/pull/12766[(#12766)]
* Update to v1.31.12-k3s1 and Go 1.23.11 https://github.com/k3s-io/k3s/pull/12763[(#12763)]
