= v1.32.X
:description: Find release details for k3s v1.32.x including Kubernetes updates and issue fixes for versions v1.32.11+k3s1 through v1.32.13+k3s1
:revdate: 2026-05-25
...
| xref:#_release_v1_32_13k3s1[v1.32.13+k3s1]
| Mar 04 2026
...
| https://github.com/k3s-io/containerd/releases/tag/v2.1.5-k3s1.32[v2.1.5-k3s1.32]
| https://github.com/opencontainers/runc/releases/tag/v1.2.9[v1.2.9]
...
| xref:#_release_v1_32_12k3s1[v1.32.12+k3s1]
| Feb 12 2026
...
| xref:#_release_v1_32_11k3s3[v1.32.11+k3s3]
| Feb 03 2026
...
| xref:#_release_v1_32_11k3s1[v1.32.11+k3s1]
| Dec 19 2025
| https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.32.md#v13211[v1.32.11]
| https://github.com/k3s-io/kine/releases/tag/v0.14.9-k3s1.32[v0.14.9-k3s1.32]
...
| xref:#_release_v1_32_10k3s1[v1.32.10+k3s1]
| Nov 20 2025
| https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.32.md#v13210[v1.32.10]
| https://github.com/k3s-io/kine/releases/tag/v0.14.6-k3s1.32[v0.14.6-k3s1.32]
| https://sqlite.org/releaselog/3_50_4.html[3.50.4]
| https://github.com/k3s-io/etcd/releases/tag/v3.5.21-k3s1[v3.5.21-k3s1]
| https://github.com/k3s-io/containerd/releases/tag/v2.1.5-k3s1.32[v2.1.5-k3s1.32]
| https://github.com/opencontainers/runc/releases/tag/v1.2.8[v1.2.8]
| https://github.com/flannel-io/flannel/releases/tag/v0.27.4[v0.27.4]
| https://github.com/kubernetes-sigs/metrics-server/releases/tag/v0.8.0[v0.8.0]
| https://github.com/traefik/traefik/releases/tag/v3.5.1[v3.5.1]
| https://github.com/coredns/coredns/releases/tag/v1.13.1[v1.13.1]
...
| xref:#_release_v1_32_9k3s1[v1.32.9+k3s1]
| Sep 22 2025
...
| https://sqlite.org/releaselog/3_50_4.html[3.50.4]
| https://github.com/k3s-io/etcd/releases/tag/v3.5.21-k3s1[v3.5.21-k3s1]
| https://github.com/k3s-io/containerd/releases/tag/v2.1.4-k3s1.32[v2.1.4-k3s1.32]
| https://github.com/opencontainers/runc/releases/tag/v1.2.7[v1.2.7]
...
| xref:#_release_v1_32_8k3s1[v1.32.8+k3s1]
| Aug 25 2025
...
== Release https://github.com/k3s-io/k3s/releases/tag/v1.32.13+k3s1[v1.32.13+k3s1]
// v1.32.13+k3s1

This release updates Kubernetes to v1.32.13, and fixes a number of issues.

For more details on what’s new, see the https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.32.md#changelog-since-v13212[Kubernetes release notes].

=== Changes since v1.32.12+k3s1:

* Rootlesskit Revert + Test Fixes https://github.com/k3s-io/k3s/pull/13683[(#13683)]
* Backports for 2026-02 BONUS RELEASE https://github.com/k3s-io/k3s/pull/13694[(#13694)]
* Bump Traefik to v3.6.9 https://github.com/k3s-io/k3s/pull/13700[(#13700)]
* Update to v1.32.13-k3s1 and Go 1.24.13 https://github.com/k3s-io/k3s/pull/13704[(#13704)]

'''

== Release https://github.com/k3s-io/k3s/releases/tag/v1.32.12+k3s1[v1.32.12+k3s1]
// v1.32.12+k3s1

This release updates Kubernetes to v1.32.12, and fixes a number of issues.

For more details on what’s new, see the https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.32.md#changelog-since-v13211[Kubernetes release notes].

=== Changes since v1.32.11+k3s3:

* Explicitly close mvcc backend to fix high CPU on initial etcd server after restart https://github.com/k3s-io/k3s/pull/13573[(#13573)]
* Backports for 2026-02 https://github.com/k3s-io/k3s/pull/13583[(#13583)]
* Bump kine for list/watch revision fixes https://github.com/k3s-io/k3s/pull/13579[(#13579)]
* Fix VPN node IP not being applied to kubelet https://github.com/k3s-io/k3s/pull/13563[(#13563)]
* Bulk Backports 2026-02 https://github.com/k3s-io/k3s/pull/13567[(#13567)]
** Bump to coredns 1.14.1 and metrics-server v0.8.1 https://github.com/k3s-io/k3s/pull/13611[(#13611)]
* Add registry prefix to image-list file https://github.com/k3s-io/k3s/pull/13599[(#13599)]
* Bump klipper-helm and klipper-lb images https://github.com/k3s-io/k3s/pull/13622[(#13622)]
* Fix removal of init node https://github.com/k3s-io/k3s/pull/13633[(#13633)]
* Update to v1.32.12-k3s1 and Go 1.24.12 https://github.com/k3s-io/k3s/pull/13634[(#13634)]

'''

== Release https://github.com/k3s-io/k3s/releases/tag/v1.32.11+k3s3[v1.32.11+k3s3]
// v1.32.11+k3s3
...
* Add firewall section to check-config.sh https://github.com/k3s-io/k3s/pull/13393[(#13393)]
* Expand docker upgrade test, sunset E2E upgrade test https://github.com/k3s-io/k3s/pull/13401[(#13401)]
* Allow k3s secrets-encrypt enable on existing clusters https://github.com/k3s-io/k3s/pull/13406[(#13406)]
* Chore: Bump charts - Jan 2025 https://github.com/k3s-io/k3s/pull/13423[(#13423)]
* Bump local path provisioner to v0.0.34 https://github.com/k3s-io/k3s/pull/13429[(#13429)]
* Bump to coredns 1.14.0 https://github.com/k3s-io/k3s/pull/13454[(#13454)]
* Backports for 2026-01 https://github.com/k3s-io/k3s/pull/13450[(#13450)]
* Rootless ports: add support for udp https://github.com/k3s-io/k3s/pull/13462[(#13462)]
* Update Traefik version to v3.6.7 https://github.com/k3s-io/k3s/pull/13481[(#13481)]
* Bump etcd to v3.5.26 for zombie member fix https://github.com/k3s-io/k3s/pull/13494[(#13494)]
* Update to v1.32.11-k3s3 and Go 1.24.11 https://github.com/k3s-io/k3s/pull/13520[(#13520)]
* Fix restart of control-plane-only nodes attempting to reconcile from local datastore https://github.com/k3s-io/k3s/pull/13538[(#13538)]

'''

== Release https://github.com/k3s-io/k3s/releases/tag/v1.32.11+k3s1[v1.32.11+k3s1]
// v1.32.11+k3s1

This release updates Kubernetes to v1.32.11, and fixes a number of issues.

For more details on what's new, see the https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.32.md#changelog-since-v13210[Kubernetes release notes].

=== Changes since v1.32.10+k3s1:

* Update busybox version to 1.37.0 https://github.com/k3s-io/k3s/pull/13239[(#13239)]
* Add multus e2e test https://github.com/k3s-io/k3s/pull/13266[(#13266)]
* Backports for 2025-12 https://github.com/k3s-io/k3s/pull/13299[(#13299)]
...
* Fix tailscale setup in case of an already running configuration https://github.com/k3s-io/k3s/pull/13269[(#13269)]
* Update kube-router to v2.6.2 https://github.com/k3s-io/k3s/pull/13290[(#13290)]
* Fix cross-platform image save https://github.com/k3s-io/k3s/pull/13313[(#13313)]
* Bump kine to v0.14.9 https://github.com/k3s-io/k3s/pull/13320[(#13320)]
* Fix arm airgap platforms https://github.com/k3s-io/k3s/pull/13333[(#13333)]
* Fix release CI https://github.com/k3s-io/k3s/pull/13342[(#13342)]
* Override DefaultHelmJob at build time https://github.com/k3s-io/k3s/pull/13363[(#13363)]
* Validate collected release artifact list before uploading https://github.com/k3s-io/k3s/pull/13360[(#13360)]
* Update to v1.32.11-k3s1 and Go 1.24.11 https://github.com/k3s-io/k3s/pull/13365[(#13365)]

'''

== Release https://github.com/k3s-io/k3s/releases/tag/v1.32.10+k3s1[v1.32.10+k3s1]
// v1.32.10+k3s1 -->

This release updates Kubernetes to v1.32.10, and fixes a number of issues.
For more details on what's new, see the https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.32.md#changelog-since-v1329[Kubernetes release notes].

=== Changes since v1.32.9+k3s1:

* Bump traefik to 3.5.1 https://github.com/k3s-io/k3s/pull/12959[(#12959)]
* Fix garbled CLI https://github.com/k3s-io/k3s/pull/13034[(#13034)]
* Update flannel, kube-router and cni plugins https://github.com/k3s-io/k3s/pull/13042[(#13042)]
* Backports for 2025-10 https://github.com/k3s-io/k3s/pull/13059[(#13059)]
...
* Update dispatch script https://github.com/k3s-io/k3s/pull/13076[(#13076)]
* Bump helm-controller/klipper-helm https://github.com/k3s-io/k3s/pull/13093[(#13093)]
* Backports for 2025-11 https://github.com/k3s-io/k3s/pull/13127[(#13127)]
* Inclusive naming proposal https://github.com/k3s-io/k3s/pull/13134[(#13134)]
* Migrate release pipeline into GitHub Actions https://github.com/k3s-io/k3s/pull/13117[(#13117)]
* Bump runc to v1.2.8 https://github.com/k3s-io/k3s/pull/13148[(#13148)]
* Add Prime assets upload https://github.com/k3s-io/k3s/pull/13157[(#13157)]
* More backports for 2025-11 https://github.com/k3s-io/k3s/pull/13179[(#13179)]
* Bump klipper-helm and helm-controller https://github.com/k3s-io/k3s/pull/13195[(#13195)]
* Update to v1.32.10-k3s1 and Go 1.24.9 https://github.com/k3s-io/k3s/pull/13202[(#13202)]
* Add id-token https://github.com/k3s-io/k3s/pull/13206[(#13206)]

'''

== Release https://github.com/k3s-io/k3s/releases/tag/v1.32.9+k3s1[v1.32.9+k3s1]
// v1.32.9+k3s1

This release updates Kubernetes to v1.32.9, and fixes a number of issues.

For more details on what's new, see the https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.32.md#changelog-since-v1328[Kubernetes release notes].

=== Changes since v1.32.8+k3s1:

* Backports for 2025-09 https://github.com/k3s-io/k3s/pull/12886[(#12886)]
...
* Update to v1.32.9-k3s1 and Go 1.23.12 https://github.com/k3s-io/k3s/pull/12894[(#12894)]

'''

== Release https://github.com/k3s-io/k3s/releases/tag/v1.32.8+k3s1[v1.32.8+k3s1]
// v1.32.8+k3s1

This release updates Kubernetes to v1.32.8, and fixes a number of issues.
For more details on what's new, see the https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.32.md#changelog-since-v1327[Kubernetes release notes].

=== Changes since v1.32.7+k3s1:

* Add retention flag specific for s3 https://github.com/k3s-io/k3s/pull/12695[(#12695)]
* Backports for August https://github.com/k3s-io/k3s/pull/12719[(#12719)]
* Bump coredns to 1.12.3 https://github.com/k3s-io/k3s/pull/12730[(#12730)]
* Bump metrics-server to v0.8.0 https://github.com/k3s-io/k3s/pull/12742[(#12742)]
* Fix cert startup check events https://github.com/k3s-io/k3s/pull/12747[(#12747)]
* Emit certs OK event on startup, if no certs need renewal https://github.com/k3s-io/k3s/pull/12761[(#12761)]
* Update metric help to be more descriptive. https://github.com/k3s-io/k3s/pull/12765[(#12765)]
* Update to v1.32.8-k3s1 and Go 1.23.11 https://github.com/k3s-io/k3s/pull/12759[(#12759)]
