= Known Issues
:description: Describe the known issues that may affect K3s, including how to check for updates on the K3s Project Issue Tracker and apply schema migrations to databases
:revdate: 2026-03-31
...
[#_kine_sql_2147483647_max_int_revision_limit]
