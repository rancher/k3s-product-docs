= Security
:description: Secure a K3s cluster by following hardening guides and using self-assessments against CIS benchmarks to validate its security configuration and ensure compliance
