= FAQ
:description: Find answers to common questions about K3s, such as its use as a Kubernetes replacement, Ingress configuration, and log locations
...
[#_is_k3s_a_suitable_replacement_for_kubernetes]
...
[#_what_is_the_difference_between_k3s_server_and_agent_tokens]
...
[#_how_compatible_are_different_versions_of_k3s]
...
[#_im_having_an_issue_where_can_i_get_help]
