...
* Laden Sie `k3s-rootless.service` von https://github.com/k3s-io/k3s/blob/main/k3s-rootless.service[`https://github.com/k3s-io/k3s/blob/main/k3s-rootless.service`] herunter.
