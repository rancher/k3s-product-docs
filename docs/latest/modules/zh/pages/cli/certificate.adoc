...
https://github.com/k3s-io/k3s/blob/main/contrib/util/generate-custom-ca-certs.sh[K3s 仓库中的 `contrib/util/generate-custom-ca-certs.sh`] 示例脚本用于预先创建证书和密钥。
...
https://github.com/k3s-io/k3s/blob/main/contrib/util/rotate-default-ca-certs.sh[K3s 仓库中的 `contrib/util/rotate-default-ca-certs.sh`] 示例脚本用于创建由现有 CA 交叉签名的更新 CA 证书和密钥。
