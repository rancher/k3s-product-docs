...
如果使用脚本或xref:installation/configuration.adoc#_configuration_with_install_script[配置选项]中描述的其他方法进行安装，请使用 `+curl -sfL https://get.k3s.io | INSTALL_K3S_ARTIFACT_URL=<PRIME-ARTIFACTS-URL>/k3s sh -s - server --secrets-encryption+`。
====
